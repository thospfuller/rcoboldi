...
#
bash cd ~/temp/eda/ && mvn clean install -DskipTests=true -U -Dhttps.protocols=TLSv1.2
bash cd ~/temp/jdataframe/ && mvn clean install -DskipTests=true -U
...
unzip /home/travis/build/thospfuller/temp/Cobol2Csv_0.90.zip -d ~/temp/Cobol2Csv/
